...
.sp-wrap *,
.sp-wrap *::before,
.sp-wrap *::after { box-sizing: border-box; margin: 0; padding: 0; }
...
.sp-breadcrumb a:hover { color: var(--green-dark); }
...
.sp-qty__btn:hover { background: var(--border); }
.sp-qty__input {
    width: 46px;
    height: 36px;
    border: none;
...
.sp-badge__icon svg { width: 28px; height: 28px; }
.sp-badge__label {
    font-size: 13px;
    font-weight: 700;
    color: var(--text-dark);
...
@media (max-width: 480px) {
    .sp-badges { grid-template-columns: 1fr 1fr; }
    .sp-nutrition__grid { grid-template-columns: 1fr 1fr; }
}
</style>
